            ...
            <div class="flex flex-col lg:flex-row lg:gap-x-8">
                <div class="flex flex-1 flex-col items-start space-y-8 mb-12 lg:mb-0 lg:pt-2">
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        <div
                            class="text-accentColor rounded-sm w-14 h-14 flex items-start justify-center mt-2 mb-4 lg:mb-0 text-2xl"
                        >
                        ...
                        <div>
                            ...
                            <p class="text-accentColor font-normal">Email me at john@doe.com</p>
                        </div>
                    </div>
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        <div
                        ...
                        <div>
                            ...
                            <p class="mb-1 text-paragraph">Dominican Republic</p>
                            <p class="text-accentColor font-normal">Serving clients worldwide</p>
                        </div>
                    </div>
                </div>
                <form @submit.prevent="submit" class="space-y-8 w-full items-center max-w-md" action="">
                    ...
                    <textarea v-model="form.body" class="textarea" placeholder="Your Message" spellcheck="false"/>
                    <span v-if="form.errors.body" class="text-sm text-red-500">{{ form.errors.body }}</span>
                    <button class="btn btn-lg bg-accentColor text-white rounded-xl">
                        Send message
                    </button>
                </form>
            </div>
